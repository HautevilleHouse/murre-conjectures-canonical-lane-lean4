/-!
# murre-conjectures-canonical-lane Lean migration boundary
...
`MurreConjecturesCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "murre-conjectures-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/murre-conjectures-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Murre conjectures: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-cycles", "cohomology", "mathematical-proof", "motives", "reproducibility", "chow-groups", "murre-conjectures", "canonical-lane", "local-to-global", "manifold-constrained"]
