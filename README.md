# Murre Conjectures — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/murre-conjectures-canonical-lane-mathlib.git
cd murre-conjectures-canonical-lane-mathlib
lake exe
lake build
```
